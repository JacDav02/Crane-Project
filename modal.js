...
// Mindstorm Brick
// Get the modal
var mindstormModal = document.getElementById("mindstorm-modal");

// Get the button that opens the modal
var mindstormButton = document.getElementById("mindstorm-button");

// Get the <span> element that closes the modal
var mindstormClose = document.getElementById("mindstorm-close");

// When the user clicks on the button, open the modal
mindstormButton.onclick = function() {
  mindstormModal.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
mindstormClose.onclick = function() {
  mindstormModal.style.display = "none";
}

// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
  if (event.target == mindstormModal) {
    mindstormModal.style.display = "none";
  }
}
